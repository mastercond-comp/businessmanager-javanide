...
public class fragment_MYFIRMS extends Fragment {
  ...
  public View onCreateView(
    ...
    View rootView = inflater.inflate(R.layout.fragment_myfirms, container, false);
...
//=================КОНЕЦ СЕКЦИИ ЗАКРЫТИЯ МЕНЮ ПРИ НАЖАТИИ НА ЭКРАН================= 
 ...
 //=================ВЫСТАВЛЕНИЕ РЕЖИМА ОТОБРАЖЕНИЯ ТЕЛЕФОН-ПЛАНШЕТ=================
    ...
    { 
     ...
     ListView LVMF = (ListView)rootView.findViewById(R.id.ListViewMyFirms);
   ...
   //=================СЕКЦИЯ ЗАПОЛНЕНИЯ СТРАНИЦЫ ДАННЫМИ ИЗ БД=================
    try {
      ...
      ListView ListViewSdelki = (ListView)rootView.findViewById(R.id.ListViewMyFirms);
      ...
      ListViewSdelki.setOnItemClickListener(
          new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
              ...
              MainActivity rootActivity = (MainActivity)getActivity(); 
              rootActivity.editmyfirm((list.get(position)).getidnumber());
    ...
    Button DBaddKONTRAGENT=(Button)rootView.findViewById(R.id.buttonaddmyfirm);
        DBaddKONTRAGENT.setOnClickListener(new View.OnClickListener() {
            @Override 
            public void onClick(View v) {
            
            MainActivity rootActivity = (MainActivity)getActivity(); 
            rootActivity.addmyfirm();
