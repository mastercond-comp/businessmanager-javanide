...
public class fragment_edit_kontragent_home extends Fragment {
        ...
        public fragment_edit_kontragent_home() {}
   ...
   View rootView = inflater.inflate(R.layout.fragment_edit_kontragent, container, false);
...
//=================КОНЕЦ СЕКЦИИ ЗАКРЫТИЯ МЕНЮ ПРИ НАЖАТИИ НА ЭКРАН================= 
 ...
 //=================ВЫСТАВЛЕНИЕ РЕЖИМА ОТОБРАЖЕНИЯ ТЕЛЕФОН-ПЛАНШЕТ=================
  ...
  Button DBdelKONTRAGENT=(Button)rootView.findViewById(R.id.butondelkontragent);
            ...
            Zagolovok.setText("Удалить контрагента из базы?");
